...
class FivemovierulzProvider : MainAPI() { // all providers must be an instance of MainAPI
    override var mainUrl = "https://5movierulz.am"
    ...
    override val mainPage = mainPageOf(
        ...
        "$mainUrl/category/multi-audio-dubbed-movies/page" to "Multi Audio",
        "$mainUrl/category/telugu-movies-2021/page" to "Telugu 2021",
        "$mainUrl/category/telugu-movies-2020/page" to "Telugu 2020",
        "$mainUrl/category/telugu-movies-2019/page" to "Telugu 2019",
    )
